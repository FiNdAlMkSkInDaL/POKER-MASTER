...
class GameManager:
    ...
    def _sync_action_history(self, round_state: Dict[str, Any], hero_reasoning: str) -> str:
        ...
        for street in STREETS:
            ...
            for native_action in native_items[seen_count:]:
                ...
                self._custom_action_history[street].append(
                    {
            ...
            players_payload.append(
                {
                    ...
                    "contribution_this_street": contributions_street.get(player_id, 0),
                    "contribution_this_hand": contributions_hand.get(player_id, 0),
    ...
    def _normalize_action_for_engine(self, action_type: str, amount: int) -> Tuple[str, int]:
        requested = ActionType(action_type).value
        requested_native = {
            "fold": "fold",
            "call": "call",
            "check": "call",
